        ...
        {wartaList.length === 0 ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6">
            {wartaList.map((item, idx) => {
              ...
              return (
                <ScrollReveal key={item.id} delay={idx * 0.08} className="h-full">
                  <article className="h-full group bg-white rounded-xl sm:rounded-2xl border border-slate-200/80 hover:border-slate-300 overflow-hidden shadow-xs hover:shadow-sm transition-all duration-200 flex flex-col justify-between">
                    <div>
